  ...
  <div id="wrapper">
    ...
    <div id="content">
        ...
        <?php
          ...
          $top_menu = str_replace("%%PAGE%%", "Błąd", $top_menu);
          echo $top_menu;
        ?>
      
        <!-- 404 Error Text -->
        <div class="text-center">
            <div class="error mx-auto" data-text="Nie masz uprawnień :(">Nie masz uprawnień :(</div>
            <p class="lead text-gray-800 mb-5">Strona dostępna wyłącznie dla administratora</p>
            <p class="text-gray-500 mb-0">Zaloguj się na konto administratora by kontynuować</p>
