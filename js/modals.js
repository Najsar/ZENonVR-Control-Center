...
function refresh()
{
    ...
    $.ajax({
        url : "include/php/form_data.php?p=day_profit",
        dataType : "json"
    })
    .done(function(res) {
        $("#day_profit").html( Round(res['data'], 2) );
    });
    $.ajax({
        url : "include/php/form_data.php?p=month_profit",
        dataType : "json"
    })
    .done(function(res) {
        $("#month_profit").html( Round(res['data'], 2) );
    });
}
