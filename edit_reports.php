  ...
  <div id="wrapper">
    ...
    <div id="content">
        ...
        <?php
          ...
          $top_menu = str_replace("%%PAGE%%", "Korekta Rozliczeń", $top_menu);
          echo $top_menu;
        ?>
      
        <div class="text-center">
            <div class="error mx-auto" data-text="W trakcie tworzenia">W trakcie tworzenia</div>
            <p class="lead text-gray-800 mb-5">Funkcjonalność zostanie dopiero dodana</p>
            <p class="text-gray-500 mb-0">Póki co zapraszam do korzystania z reszty funkcji</p>
